...
import 'package:gaurdianeve/Pages/MainScreen/HomeScreens/SettingScreen/feedback.dart';

import 'package:gaurdianeve/Pages/MainScreen/HomeScreens/SettingScreen/help_and_service.dart';
...
class Setting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double settingContainerHeight =
        height * aspectRatio - 50; // Adjusted calculation
        ...
        children: [
          ...
          Container(
            ...
            child: ListView(children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    if (inviteFieldController.text.isNotEmpty) {
                                      final Invite invite = Invite(
                                          senderUsername: user.username,
                                          byUser: FirebaseAuth
                                              .instance.currentUser!.uid,
                                          reciverID: inviteFieldController.text,
                                          status: "pending",
              ...
              GestureDetector(
                onTap: () {
                  BlocProvider.of<AuthBLocBloc>(context).add(SignOut());
                },
                child: const Option(
