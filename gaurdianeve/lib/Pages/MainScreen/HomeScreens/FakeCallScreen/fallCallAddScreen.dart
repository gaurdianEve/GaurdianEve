...
class FakeCallAddScreen extends StatelessWidget {
  const FakeCallAddScreen({super.key});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          if (_fakename.text.isNotEmpty && _fakephoneNo.text.isNotEmpty) {
            ...
            BlocProvider.of<FakeCallBloc>(context).add(AddFakeContact(contact: contact ));
